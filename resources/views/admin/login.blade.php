...
<body>
                ...
                <div class="md:w-1/2 bg-white p-10">
                    ...
                    <form id="loginForm" class="space-y-6">
                        ...
                        <div id="errorMessage" class="error-message hidden">
                            <div class="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-red-700">These credentials do not match our records.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="email" id="email" name="email" required class="form-input block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#68D6EC] focus:border-[#68D6EC]" placeholder="you@example.com">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember" name="remember" type="checkbox" class="h-4 w-4 text-[#68D6EC] focus:ring-[#68D6EC] border-gray-300 rounded">
                                <label for="remember" class="ml-2 block text-sm text-gray-700">Remember me</label>
                            </div>
                            
                            <div class="text-sm">
                                <a href="#" class="font-medium text-[#68D6EC] hover:text-[#4a9ff5]">Forgot your password?</a>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="#" class="font-medium text-[#68D6EC] hover:text-[#4a9ff5]">Register</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            const validEmail = 'admin@clinicflow.com';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Uncomment the lines below to auto-fill demo credentials for testing
            // document.getElementById('email').value = 'admin@clinicflow.com';
